export const aboutMe={
     title: 'About Me',
     description: 'Assalamualaikum, my name is Marzan and I am a frontend developer from Bangladesh with a passion for creating dynamic and efficient frontend applications. I specialize in working with ReactJS and the TailwindCSS, and I am always eager to learn new technologies and improve my skills to deliver the best possible solutions for my clients. I am an experienced developer with a strong background in creating Frontend applications that are both functional and visually appealing. Connect with me to know more about my skills and experience.'
}
...
export const hero={
     welcome: 'Assalamualaikum. I am',
     name: 'Marzan',
     nickname: 'Bin Rahman',
     profession: 'Passionate Frontend Developer',
     motto: 'My motto is,'
}